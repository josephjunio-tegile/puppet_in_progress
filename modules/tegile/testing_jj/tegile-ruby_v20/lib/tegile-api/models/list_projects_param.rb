...
module IFClient
  ...
  class ListProjectsParam
    # The name of the pool for which projects need to be listed.
    attr_accessor :arg0_pool_name

    # A true returns the local projects only; a false returns the replicated projects only.
    attr_accessor :arg1_local
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'arg1_Local')
        self.arg1_local = attributes[:'arg1_Local']
      end
    ...
    def list_invalid_properties
      ...
      if @arg1_local.nil?
        invalid_properties.push("invalid value for 'arg1_local', arg1_local cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @arg1_local.nil?
      return true
    end
    ...
    def hash
      [arg0_pool_name, arg1_local].hash
    end
