...
module IFClient
  class NetworkApi
    ...
    def get_floating_ip_list_post(get_floating_ip_list_param, opts = {})
    ...
    # @param get_floating_ip_list_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<FloatingIP_V2_2>, Fixnum, Hash)>] Array<FloatingIP_V2_2> data, response status code and response headers
    def get_floating_ip_list_post_with_http_info(get_floating_ip_list_param, opts = {})
