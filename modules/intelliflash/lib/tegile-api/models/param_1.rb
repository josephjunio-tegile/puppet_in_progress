...
module IFClient
  ...
  class Param1
    # Path to a project snapshot.  The snapshot path has the format: PoolName/Local/ProjectName@SnapshotName.  You can get the snapshotPath from the listSnapshots API. For more information, see listSnapshots. 
    ...
    def hash
      [arg0_snapshot_path, arg1_clone_name].hash
    end
