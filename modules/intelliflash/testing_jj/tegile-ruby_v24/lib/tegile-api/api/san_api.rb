...
module IFClient
  class SANApi
    ...
    # @param get_project_default_fc_it_view_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ITView_V2_1>, Fixnum, Hash)>] Array<ITView_V2_1> data, response status code and response headers
    ...
    # @param list_fc_initiators_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<FCInitiator_V2_1>, Fixnum, Hash)>] Array<FCInitiator_V2_1> data, response status code and response headers
    def list_fc_initiators_post_with_http_info(list_fc_initiators_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<FCInitiator_V2_1>')
      if @api_client.config.debugging
    ...
    # @param list_fc_targets_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<FCTarget_V2_1>, Fixnum, Hash)>] Array<FCTarget_V2_1> data, response status code and response headers
    def list_fc_targets_post_with_http_info(list_fc_targets_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<FCTarget_V2_1>')
      if @api_client.config.debugging
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<InitiatorGroup_V2_1>, Fixnum, Hash)>] Array<InitiatorGroup_V2_1> data, response status code and response headers
    def list_initiator_groups_get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<InitiatorGroup_V2_1>')
      if @api_client.config.debugging
    ...
    # @param list_iscsi_initiators_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ISCSIInitiator_V2_1>, Fixnum, Hash)>] Array<ISCSIInitiator_V2_1> data, response status code and response headers
    def list_iscsi_initiators_post_with_http_info(list_iscsi_initiators_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<ISCSIInitiator_V2_1>')
      if @api_client.config.debugging
    ...
    # @param list_iscsi_targets_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ISCSITarget_V2_1>, Fixnum, Hash)>] Array<ISCSITarget_V2_1> data, response status code and response headers
    def list_iscsi_targets_post_with_http_info(list_iscsi_targets_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<ISCSITarget_V2_1>')
      if @api_client.config.debugging
    ...
    def list_target_groups_get(opts = {})
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<TargetGroup_V2_2>, Fixnum, Hash)>] Array<TargetGroup_V2_2> data, response status code and response headers
    def list_target_groups_get_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # 
    # @param move_initiator_to_initiator_group_param 
    # @param [Hash] opts the optional parameters
    # @return [COMMAND_STATUS]
    def move_initiator_to_initiator_group_post(move_initiator_to_initiator_group_param, opts = {})
      data, _status_code, _headers = move_initiator_to_initiator_group_post_with_http_info(move_initiator_to_initiator_group_param, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(COMMAND_STATUS, Fixnum, Hash)>] COMMAND_STATUS data, response status code and response headers
    def move_initiator_to_initiator_group_post_with_http_info(move_initiator_to_initiator_group_param, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SANApi.move_initiator_to_initiator_group_post ..."
      end
      # verify the required parameter 'move_initiator_to_initiator_group_param' is set
      if @api_client.config.client_side_validation && move_initiator_to_initiator_group_param.nil?
        fail ArgumentError, "Missing the required parameter 'move_initiator_to_initiator_group_param' when calling SANApi.move_initiator_to_initiator_group_post"
      end
      # resource path
      local_var_path = "/moveInitiatorToInitiatorGroup"
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(move_initiator_to_initiator_group_param)
      auth_names = ['basicAuth']
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :return_type => 'COMMAND_STATUS')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SANApi#move_initiator_to_initiator_group_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
