...
module IFClient
  ...
  class ShareV10
    ...
    # This field is a string that uniquely identifies the share on a Tegile array.  A dataset path should have the format: PoolName/Local/ProjectName/ShareName. 
    attr_accessor :dataset_path

    # Identifies whether the share belongs to a local project or a replicated project.
    attr_accessor :local

    # This string exposes the mountpoint of the share on a Tegile array.
    ...
    def hash
      [available_size, dataset_path, local, mountpoint, name, pool_name, project_name, total_size].hash
    end
