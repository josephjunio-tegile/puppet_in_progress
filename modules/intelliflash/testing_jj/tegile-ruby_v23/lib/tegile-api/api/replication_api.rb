...
module IFClient
  class ReplicationApi
    ...
    # @param get_replication_config_list_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ReplicationConfig_V1_2>, Fixnum, Hash)>] Array<ReplicationConfig_V1_2> data, response status code and response headers
    def get_replication_config_list_post_with_http_info(get_replication_config_list_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Array<ReplicationConfig_V1_2>')
      if @api_client.config.debugging
    ...
    # @param get_replication_status_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReplicationStatus_V1_2, Fixnum, Hash)>] ReplicationStatus_V1_2 data, response status code and response headers
    def get_replication_status_post_with_http_info(get_replication_status_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ReplicationStatus_V1_2')
      if @api_client.config.debugging
