...
module IFClient
  ...
  class BaseDatasetV21
    ...
    def hash
      [project_name, pool_name, local_dataset, purpose, compression, compressed_log, dedup, copies, primary_cache, secondary_cache, readonly, logbias, sync, zfs_data_set_name].hash
    end
