...
module IFClient
  class DataApi
    ...
    # @param get_project_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Project_V2_1, Fixnum, Hash)>] Project_V2_1 data, response status code and response headers
    ...
    # @param get_share_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Share_V2_1, Fixnum, Hash)>] Share_V2_1 data, response status code and response headers
    ...
    # @param get_volume_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Volume_V2_1, Fixnum, Hash)>] Volume_V2_1 data, response status code and response headers
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Pool_V1_0>, Fixnum, Hash)>] Array<Pool_V1_0> data, response status code and response headers
    ...
    # @param list_projects_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Project_V1_0>, Fixnum, Hash)>] Array<Project_V1_0> data, response status code and response headers
    def list_projects_post_with_http_info(list_projects_param, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<Project_V1_0>')
      if @api_client.config.debugging
    ...
    # @param list_shares_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Share_V1_0>, Fixnum, Hash)>] Array<Share_V1_0> data, response status code and response headers
    ...
    # @param list_volumes_param 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Volume_V1_0>, Fixnum, Hash)>] Array<Volume_V1_0> data, response status code and response headers
